              ...
              <div className="flex items-top row-start-2 md:row-start-1">
                <div>
                  ...
                  <div className="flex font-display text-sm md:text-base lg:text-md mb-4">
                    <p className="my-4">
                      A simple, fast and scalable bug tracking system that helps you manage, track and resolve issues
                      efficiently, delivering great products on time.
                    </p>
                  </div>
                  <div className="flex mt-8 uppercase">
                    <Button href={ROUTE.signUp} label="Sign Up for free" variant="primary" size="medium" />
                  </div>
                </div>
              </div>
              ...
              <Marquee autoFill>
                <div className="flex w-full justify-center">
                  <div className="mx-6 flex items-center justify-center md:mx-8 xl:mx-12">
                    <Image src="/aws_logo.svg" width={60} height={30} alt="Amazon Web Services" />
                  </div>
                  <div className="mx-6 flex items-center justify-center md:mx-8 xl:mx-12">
                    <Image src="/next.svg" width={77} height={35} alt="Nextjs" />
                  </div>
                  <div className="mx-6 flex items-center justify-center md:mx-8 xl:mx-12">
                    <Image src="/Tubi_logo_1.svg" width={77} height={35} alt="AWS" />
                  </div>
                  <div className="mx-6 flex items-center justify-center md:mx-8 xl:mx-12">
                    <Image src="/ByteDance_logo.svg" width={140} height={70} alt="ByteDance" />
                  </div>
                  <div className="mx-6 flex items-center justify-center md:mx-8 xl:mx-12">
                    <Image src="/GSK_logo.svg" width={77} height={35} alt="GSK" />
                  </div>
                  <div className="mx-6 flex items-center justify-center md:mx-8 xl:mx-12">
                    <Image src="/vercel.svg" width={77} height={35} alt="Vercel" />
                  </div>
                </div>
              </Marquee>
          ...
          <div className="container md:container mx-auto">
            ...
            <div className="flex flex-col gap-4 lg:gap-8 sm:grid sm:grid-cols-1 sm:gap-8 lg:grid-cols-3 lg:space-y-0">
              <div className="overflow-hidden flex flex-col p-6 sm:py-8 rounded-2xl bg-[#e2f8e2] hover:bg-gray-100">
                <h2 className="font-display text-md md:text-xl font-bold mb-4 text-gray-400">Customizable Tracker</h2>
                <div>
                  <p className="font-display text-sm md:text-base mb-2">
                    With BugTracker, you can build a custom issue tracker app that perfectly fits your tem&apos;s
                    workflow. Use drag-and-drop widgets to add features like issue logging, tracking, and resolution
              ...
              <div className="overflow-hidden flex flex-col p-6 sm:py-8 rounded-2xl bg-[#fce8e0] hover:bg-gray-100">
                ...
                <div>
                  <p className="font-display text-sm md:text-base mb-2">
                    BugTracker allows you to integrate your issue tracker app with your existing databases or
                    third-party APIs. Fetch and update issue data in real-time, ensuring your team always has the most
              ...
              <div className="overflow-hidden flex flex-col p-6 sm:py-8 rounded-2xl bg-[#c7d8ff] hover:bg-gray-100">
                ...
                <div>
                  <p className="font-display text-sm md:text-base mb-2">
                    BugTracker&apos;s user-friendly interface makes it easy for anyone to build an issue tracker app.
                    Its pre-built widgets and intuitive design tools eliminate the need for extensive coding skills,
                    making app development accessible to all team members.
                  </p>
                </div>
              </div>
            </div>
