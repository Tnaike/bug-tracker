    ...
    <div className="relative scroll-smooth bg-white">
      ...
      <div className="flex bg-slate-50 py-6">
        <div className="container md:container px-4 md:px-8 mx-auto">
          <section className="flex max-sm:flex-col gap-10 py-4 text-sm md:text-base justify-center text-gray-800">
            <div className="flex flex-col bg-white border border-gray-200 md:w-[450px] p-6 rounded-2xl shadow-[0_4px_30px_rgba(0,0,0,.2)]">
              <div className="flex flex-col pt-5">
                ...
                <div className="flex mb-6">
                  <Button label="Free Forever" variant="info" size="medium" className="md:w-full" />
                </div>
                <div className="flex">
                  <ul className="[&_>_li]:py-1 text-sm text-gray-800 list-image-[url(/images/check.svg)] list-inside marker:text-lg marker:text-fuchsia-700">
                    <li>100MB Storage</li>
            ...
            <div className="flex flex-col bg-white border border-gray-200 md:w-[450px] p-6 rounded-2xl shadow-[0_4px_30px_rgba(0,0,0,.2)]">
              <div className="flex flex-col pt-5">
                ...
                <div className="flex mb-6">
                  <Button label="Get Started" variant="primary" size="medium" className="md:w-full" />
                </div>
